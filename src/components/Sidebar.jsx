...
export default function Sidebar() {
  ...
  return (
    <aside className="sidebar">
      ...
      />
      <h1 className="sidebar-name">Aryan Yadav</h1>
      <p className="sidebar-username">aryanx82</p>
      ...
      <a
        href="https://github.com/aryanx82"
        target="_blank"
        rel="noreferrer"
      ...
      <div className="sidebar-socials">
        <a
          href="https://www.linkedin.com/in/aryan-yadav-9a5686273/"
          target="_blank"
          rel="noreferrer"
